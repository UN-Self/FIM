export const EVENT_NAME = {
  ...
  fimEditDefaultTemplates: "fim-edit-default-templates",
  fimEmbedDocuments: "fim-embed-documents",
  fimEnableModelDownload: "fim-enable-model-download",
  fimFetchOllamaModels: "fim-fetch-ollama-models",
  ...
  fimListTemplates: "fim-list-templates",
  fimManageTemplates: "fim-manage-templates",
  ...
  fimSetOllamaModel: "fim-set-ollama-model",
